        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-3">
                    ...
                    <li><a class="dropdown-item py-2" href="/onlinecourse/index.php?controller=student&action=dashboard"><i class="fas fa-columns me-2 text-primary"></i>Tổng quan</a></li>
